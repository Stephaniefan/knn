...
public class Attribute {
    ...
    private HashMap<String, Double> valueMap;    // for classes, set of possible values
    
    public String getName() { return name; }
    public Type getType() {    return type;    }
    public HashMap<String, Double> getValueSet() {return valueMap;}
    ...
    public String toString() {
        return "Attribute [name=" + name + ", type=" + type + ", valueSet=" + valueMap + "]";
    }
